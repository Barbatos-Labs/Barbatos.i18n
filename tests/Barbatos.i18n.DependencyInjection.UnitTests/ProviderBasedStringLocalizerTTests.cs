...
public sealed class ProviderBasedStringLocalizerTTests
{
    [Fact]
    public void Indexer_ReturnsLocalizedString()
    {
        ...
        var localizer = new ProviderBasedStringLocalizer<TestResource>(localizations, cultureManager);
    ...
    [Fact]
    public void IndexerWithArgs_ReturnsKey_IfNotFound()
    {
        var cultureManager = new LocalizationCultureManager();
        cultureManager.SetCulture(new CultureInfo("en-US"));
    ...
    [Fact]
    public void GetAllStrings_ReturnsAllStringsForResource()
    {
        var cultureManager = new LocalizationCultureManager();
        cultureManager.SetCulture(new CultureInfo("en-US"));
